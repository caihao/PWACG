...
if __name__ == "__main__":
    ...
    if truth_phikk == True :
        ...
        phikk_data = calc.data_info()
        # calculate data
        phikk_data.address = "data/mc_truth/"#原始truth地址
        #phikk_data.address = "data/phase_mc/"
        phikk_data.filename = "Momentum_kk.npz"
        phikk_data.id = "kk"
        phikk_data.size = 5000000
        phikk_data.begain = 0
        phikk_data.end = 5000000
        phikk_data.slices = 100
        mycdl = calc.CompoundDataForTensor(phikk_data)
        mycdl.g_id = 0
        mycdl.gpu_id = 1
